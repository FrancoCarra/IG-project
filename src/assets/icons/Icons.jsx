export const InstagramLogo = () => {
 ...
 export const ReelsLogo = () => {
    return (
        ...
        <path d="M2 12.001v3.449c0 2.849.698 4.006 1.606 4.945.94.908 2.098 1.607 4.946 1.607h6.896c2.848 0 4.006-.699 4.946-1.607.908-.939 1.606-2.096 1.606-4.945V8.552c0-2.848-.698-4.006-1.606-4.945C19.454 2.699 18.296 2 15.448 2H8.552c-2.848 0-4.006.699-4.946 1.607C2.698 4.546 2 5.704 2 8.552Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path><path d="M9.763 17.664a.908.908 0 0 1-.454-.787V11.63a.909.909 0 0 1 1.364-.788l4.545 2.624a.909.909 0 0 1 0 1.575l-4.545 2.624a.91.91 0 0 1-.91 0Z" fillRule="evenodd">
        </path></svg>
    )
}
 ...
 export const CreateContentLogo = () => {
    return (
        <svg 
        aria-label="New post" 
        className="x1lliihq x1n2onr6 x5n08af" 
...
export const ThreadsLogo = () => {
 ...
 export const BarsLogo = () => {
    return (
        ...
        width="24">
        <title></title>
        <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="4" y2="4"></line><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="12" y2="12"></line>
        <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="3" x2="21" y1="20" y2="20">
        </line></svg>
    )
}

export const ArrayIcons = [InstagramLogo, HouseLogo,SearchLogo,CompassLogo,CompassLogo,ReelsLogo,MessagesLogo,LikeLogo,CreateContentLogo,ThreadsLogo,BarsLogo]
...
export const SendLogo = () => {
    return (
        ...
        width="24">
            ...
            <line fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="2" x1="22" x2="9.218" y1="3" y2="10.083"></line><polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" 
        stroke="currentColor" 
        strokeLinejoin="round" 
        strokeWidth="2">
        </polygon>
...
export const CardsIcons = [LikeLogo, CommentLogo, SendLogo]
